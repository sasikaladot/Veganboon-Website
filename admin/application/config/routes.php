...
//Category//
$route['category'] = 'category/categoryList';
$route['add-category'] = 'category/addCategory';
$route['view-category/(:num)'] = 'category/viewCategory/$1';
$route['edit-category/(:num)'] = 'category/editCategory/$1';

//Product//
$route['product'] = 'product/productList';
$route['add-product'] = 'product/addProduct';
$route['view-product/(:num)'] = 'product/viewProduct/$1';
$route['edit-product/(:num)'] = 'product/editProduct/$1';
